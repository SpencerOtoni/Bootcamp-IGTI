...
export default function GradesControl({ grades, onDelete, onPersist }) {
  ...
  function handleActionClick(id, type) {
  ...
  return (
    <div className="container center">
      {tableGrades.map(({ id, grades }) => {
        ...
        const styleGrade = finalGrade >= 70 ? style.goodGrade : style.badGrade;
        return (
          <table style={style.table} className="striped" key={id}>
            <thead>
              <tr>
            ...
            <tfoot>
              <tr>
                ...
                <td>
                  <span style={styleGrade}>{finalGrade}</span>
                </td>
              </tr>
            </tfoot>
          </table>
